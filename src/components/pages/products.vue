<template>
  <div>
    ...
    <div class="text-right mt-4">
      <button class="btn btn-primary" @click="openModal('newData')">建立新產品</button>
    </div>
    <table class="table mt-4">
      ...
      <tbody>
        <tr v-for="(item) in products" :key="item.id">
          ...
          <td>
            <button class="btn btn-outline-danger btn-sm" @click="delModal('delData',item)">刪除</button>
          </td>
        </tr>
      </tbody>
    </table>
    <pagination :pagination="pagination" @getpagination="getProducts"></pagination>
    <!-- modal -->
    <div
      class="modal fade"
      id="productModal"
    ...
    >
      <div class="modal-dialog" role="document">
        <div class="modal-content border-0">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">取消</button>
            <button type="button" class="btn btn-danger" @click="updataProduct">確認刪除</button>
          </div>
        </div>
      </div>
    </div>
